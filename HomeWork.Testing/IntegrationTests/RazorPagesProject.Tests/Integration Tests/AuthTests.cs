...
namespace RazorPagesProject.Tests.Integration_Tests
{
    public class AuthTests : 
        IClassFixture<CustomWebApplicationFactory<IntegrationTestsSample.Startup>>
    {
        private readonly CustomWebApplicationFactory<IntegrationTestsSample.Startup> 
            _factory;

        public AuthTests(
            CustomWebApplicationFactory<IntegrationTestsSample.Startup> factory)
        {
            _factory = factory;
        }
